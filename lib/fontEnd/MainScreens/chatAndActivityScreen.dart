...
import 'package:chatting/fontEnd/Services/ChatManagement/chat_screen.dart';
import 'package:chatting/fontEnd/Services/search_screen.dart';
...
class _ChatAndActivityScreenState extends State<ChatAndActivityScreen> {
  ...
  final List<String> _allUserConnectionActivity = ['Generation', 'Kawchar'];
